      ...
      <div className="flex flex-col items-center space-y-6 max-w-xs">
          ...
          {inviteCode && (
            <div className="flex items-center gap-2">
              ...
              <code className="bg-white/50 px-2 py-1 rounded text-sm font-mono">{inviteCode}</code>
            </div>
          )}
        </div>
        ...
        <div className="mt-8 space-y-4 w-full max-w-xs">
          <a
            href={deepLinkUrl}
            className="block w-full bg-black text-white py-4 rounded-full font-semibold shadow-lg hover:bg-gray-800 transition-transform active:scale-95"
          >
            Open App
          </a>
        </div>
